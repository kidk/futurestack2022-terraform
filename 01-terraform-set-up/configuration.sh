...
#
# Create a User API Key (NEW_RELIC_API_KEY) for your New Relic account and add it here with your account ID (NEW_RELIC_ACCOUNT_ID).
# Double check you have the right region by looking at the url of your browser when you're in New Relic. EU accounts will show `eu` at the beginning of the url.
